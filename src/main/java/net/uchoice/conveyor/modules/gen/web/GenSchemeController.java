 ...
 */
package net.uchoice.conveyor.modules.gen.web;
...
import net.uchoice.conveyor.modules.gen.service.GenSchemeService;
import net.uchoice.conveyor.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("net.uchoice.conveyor.modules");
		}
